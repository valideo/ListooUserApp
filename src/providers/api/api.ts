...
export class ApiProvider {
  ...
  apiLogin(email: string, password: string) {
    ...
    return new Promise((resolve) => {
      this.http
        .post(this.apiBaseUrl + 'users/loginUser/', postData, options)
        .subscribe(
          (data) => {
          ...
          (err) => {
            if (err.status == 400) {
              ...
              this.presentAlertConnexion(
                'Ha acontecido un error en el servidor'
              );
            }
          }
        );
  ...
  apiLoginFB(email: string) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(this.apiBaseUrl + 'users/loginUserFB/', postData, options)
        .subscribe(
          (data) => {
            this.token = data['token'];
            this.events.publish('tokenOk');
  ...
  apiSendMail(email: string) {
    ...
    return new Promise((resolve) => {
      this.http
        .post(this.apiBaseUrl + 'users/sendMail/', postData, options)
        .subscribe(
          (data) => {
            resolve(data);
          },
          (err) => {
            if (err.status == 500) {
              this.presentAlertConnexion(
                'Es imposible enviar el mail de reinicializacion.'
              );
            }
          }
        );
  ...
  apiRegister(email: string, password: string, sName: string, fName: string) {
    ...
    return new Promise((resolve) => {
      this.http
        .post(this.apiBaseUrl + 'users/registerUser/', postData, options)
        .subscribe(
          (data) => {
            resolve(data);
          ...
          (err) => {
            if (err.status == 400) {
              ...
              this.presentAlertConnexion(
                'Una cuenta con este email ya ha sido creada.'
              );
            } else {
              this.presentAlertConnexion(
                'Ha acontecido un error en el servidor'
  ...
  apiLoadProfile() {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.get(this.apiBaseUrl + 'users/me/', options).subscribe(
        (data) => {
          resolve(data);
        },
        (err) => {
          console.log(err);
          this.presentAlertOK(
            'imposible de cargar la informacion, verifique su conexion.'
          );
        }
      );
    });
  ...
  apiLoadResto(userId: number) {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.get(this.apiBaseUrl + 'users/' + userId, options).subscribe(
        (data) => {
          resolve(data);
        },
        (err) => {
  ...
  apiLoadRestosWithFilter(queryString: string) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(this.apiBaseUrl + 'users/filter/' + queryString, options)
        .subscribe(
          (data) => {
            resolve(data);
          },
  ...
  apiUpdateMe(email: string, sName: string, fName: string) {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.put(this.apiBaseUrl + 'users/me/', postData, options).subscribe(
        (data) => {
          resolve(data);
          console.log(data);
        },
  ...
  apiGetAnnonce(id: number) {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.get(this.apiBaseUrl + 'annonce/' + id, options).subscribe(
        (data) => {
          resolve(data);
        },
        (err) => {
  ...
  apiGetAnnonceByResto(idResto: number) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(this.apiBaseUrl + 'annonce/resto/' + idResto, options)
        .subscribe(
          (data) => {
            resolve(data);
          },
  ...
  apiGetAllAnnonces() {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.get(this.apiBaseUrl + 'annonces/', options).subscribe(
        (data) => {
          resolve(data);
        },
        (err) => {
  ...
  apiGetCommandes() {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.get(this.apiBaseUrl + 'commandes/user', options).subscribe(
        (data) => {
          resolve(data);
        },
        (err) => {
  ...
  apiGetCommandesByAnnonce(id: number) {
    ...
    let options = { headers: headers };
    return new Promise((resolve, reject) => {
      this.http.get(this.apiBaseUrl + 'commandes/' + id, options).subscribe(
        (data) => {
          resolve(data);
        },
        (err) => {
  ...
  apiCreateCommande(idAnnonce: number, qtite: number, date: Date) {
    ...
    return new Promise((resolve) => {
      this.http
        .post(this.apiBaseUrl + 'commande/create/', postData, options)
        .subscribe(
          (data) => {
            resolve(data);
          },
