...
export class ProfilPage {
  ...
  constructor(
    ...
    if (this.apiProvider.token !== '') this.loadInfos();
  }
  ...
  loadInfos() {
    this.apiProvider.apiLoadProfile().then(
      (data) => {
  ...
  disconnect() {
    this.nativeStorage.remove('listooUserCredentials').then(
      (data) => {
  ...
  editInfos() {
    if (this.isDisabled == true) {
      ...
      this.apiProvider.apiUpdateMe(this.email, this.sName, this.fName).then(
        (data) => {
